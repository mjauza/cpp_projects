...
void test_merton_char()
{
    ...
    std::complex<double> merton_char = PricingFun::merton_char_func(u, T, r, jump_mu, jump_sigma, lambda);    
    std::function<std::complex<double>(std::complex<double>)> merton_func = PricingFun::get_merton_char_func(T, r, jump_mu, jump_sigma, lambda);
